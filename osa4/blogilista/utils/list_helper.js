...
const favoriteBlog = (blogs) => {
  ...
  return blogs.length === 0 ? undefined : authorObject
}
...
const mostBlogs = (blogs) => {
  ...
  return blogsPartioned.length === 0 ? undefined : mostBlogsAuthor
}
...
const mostLikes = (blogs) => {
  ...
  return blogsPartioned.length === 0 ? undefined : mostLikesAuthor
}
